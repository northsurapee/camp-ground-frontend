...
export default function YourBookingCard({
  booking,
}: {
  booking: BookingResponse;
}) {
  return (
    <div className="h-[150px] w-full flex rounded-[30px] bg-[#1E2F3C] bg-opacity-30 border border-[#1A2848]">
      ...
      <div className="p-5 w-full flex justify-between">
        <div>
          ...
          <div className="flex justify-start items-center gap-3 px-3 py-2 rounded-xl bg-[#4D6163] mt-2">
            <Calendar size={16} color="#ffffff" strokeWidth={2} />
            <p className="text-white font-semibold text-[14px] tracking-[0.1em]">
